...
const BASE_TABS: [Tab, string][] = [['home', '홈'], ['acct', '계정'], ['rank', '랭킹']]
...
/** 홈 · 계정 · 랭킹, plus 관리 for the admin. */
export function BottomNav({ tab, onGo, isAdmin = false }: { tab: Tab; onGo: (t: Tab) => void; isAdmin?: boolean }) {
